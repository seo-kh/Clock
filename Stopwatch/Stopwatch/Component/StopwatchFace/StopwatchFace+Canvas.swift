//
//  StopwatchFace+Canvas.swift
//  Stopwatch
//
//  Created by james seo on 2/24/26.
//
...
#Preview("First Lap: 30[s]") {
    StopwatchFace.Native(total: 30.0, split: 30.0)
...
#Preview("progress..") {
    StopwatchFace.Native(total: 555.0, split: 20.0) // total: 9m 15s, split: 20 [sec]
        .frame(width: 500, height: 500)
        .padding()
        .background(CKColor.background)
}
